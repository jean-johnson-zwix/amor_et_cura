      ...
      {results && (
        <div className="rounded-[14px] border border-[#e2e8f0] bg-white p-5">
          <div className="mb-4 border-b border-[#e2e8f0] pb-3 flex items-center gap-2">
            ...
            <span className="rounded-full bg-teal-light px-2 py-0.5 text-[11px] font-medium text-[#007b58]">
          ...
          <div className="flex gap-3">
            <Link href="/clients"
              className="inline-flex h-9 items-center rounded-lg bg-teal px-5 text-[13px] font-medium text-white transition-colors hover:bg-[#009e77]">
              View clients
            </Link>
            <button onClick={handleReset}
              className="inline-flex h-9 items-center rounded-lg border border-[#e2e8f0] bg-white px-4 text-[13px] font-medium text-navy hover:bg-teal-tint">
